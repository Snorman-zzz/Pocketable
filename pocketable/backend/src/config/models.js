...
exports.REACT_NATIVE_EXPERT_PROMPT = exports.MODELS = void 0;
exports.MODELS = {
    claude: {
        provider: 'anthropic',
...
exports.REACT_NATIVE_EXPERT_PROMPT = `You are an expert React Native and Expo developer specializing in building production-ready mobile applications.

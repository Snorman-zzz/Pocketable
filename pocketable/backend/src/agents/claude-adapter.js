...
const pocketable_prompt_1 = require("../config/pocketable-prompt");
class ClaudeAdapter {
    client;
    constructor() {
    ...
    buildSystemPrompt(mode, thinkingEnabled) {
        ...
        return pocketable_prompt_1.POCKETABLE_PROMPT + modeInstructions + thinkingInstructions;
    }
